...
public class Main {
    ...
    public static void scrollTextSceneCustom1(SignBoard board, String text[]) {
    ...
    public static void scrollTextSceneCustom2(SignBoard board, String text1, String text2) {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            scrollTextSceneCustom2(signBoard, "$$$$$ C A S I N O $$$$$", "$$$$$    C.4.Q    $$$$$");
            scrollTextSceneCustom1(signBoard, dollarSign1);
            scrollTextSceneCustom1(signBoard, dollarSign2);
            scrollTextSceneCustom1(signBoard, dollarSign3);
